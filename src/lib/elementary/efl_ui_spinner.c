...
EOLIAN static Eina_Bool
_efl_ui_spinner_elm_widget_on_focus(Eo *obj, Efl_Ui_Spinner_Data *sd, Elm_Object_Item *item EINA_UNUSED)
{
...
EOLIAN static void
_efl_ui_spinner_elm_widget_access(Eo *obj, Efl_Ui_Spinner_Data *_pd EINA_UNUSED, Eina_Bool acs)
{
