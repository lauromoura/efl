...
_anchor_calc(Evas_Object *obj)
{
   ...
   if (sd->used_align != EFL_UI_POPUP_ALIGN_NONE)
     efl_gfx_position_set(efl_super(obj, EFL_UI_POPUP_CLASS), pos.x, pos.y);
}
...
EOLIAN static Efl_Object *
_efl_ui_popup_anchor_efl_object_constructor(Eo *obj, Efl_Ui_Popup_Anchor_Data *pd EINA_UNUSED)
{
...
_efl_ui_popup_anchor_elm_widget_theme_apply(Eo *obj, Efl_Ui_Popup_Anchor_Data *pd EINA_UNUSED)
{
...
EOLIAN static void
_efl_ui_popup_anchor_efl_gfx_position_set(Eo *obj, Efl_Ui_Popup_Anchor_Data *pd EINA_UNUSED, int x, int y)
{
   _anchor_detach(obj);
