...
#ifndef _EFL_ANIMATION_OBJECT_GROUP_PARALLEL_EO_CLASS_TYPE
#define _EFL_ANIMATION_OBJECT_GROUP_PARALLEL_EO_CLASS_TYPE

typedef Eo Efl_Animation_Object_Group_Parallel;

#endif

#ifndef _EFL_ANIMATION_OBJECT_GROUP_SEQUENTIAL_EO_CLASS_TYPE
#define _EFL_ANIMATION_OBJECT_GROUP_SEQUENTIAL_EO_CLASS_TYPE

typedef Eo Efl_Animation_Object_Group_Sequential;

#endif

struct _Efl_Animation_Object_Animate_Event_Info
{
   double progress;
};
