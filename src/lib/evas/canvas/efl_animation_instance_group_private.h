...
#define EFL_ANIMATION_INSTANCE_GROUP_DATA_GET(o, pd) \
   Efl_Animation_Instance_Group_Data *pd = efl_data_scope_get(o, EFL_ANIMATION_INSTANCE_GROUP_CLASS)

typedef struct _Efl_Animation_Instance_Group_Data
{
   Eina_List *instances;
} Efl_Animation_Instance_Group_Data;
