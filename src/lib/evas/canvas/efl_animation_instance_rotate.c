#include "efl_animation_instance_rotate_private.h"

EOLIAN static void
_efl_animation_instance_rotate_rotate_set(Eo *eo_obj,
                                          Efl_Animation_Instance_Rotate_Data *pd,
                                          double from_degree,
                                          double to_degree,
...
EOLIAN static void
_efl_animation_instance_rotate_efl_animation_instance_duration_set(Eo *eo_obj,
                                                                   Efl_Animation_Instance_Rotate_Data *pd EINA_UNUSED,
                                                                   double duration)
{
   EFL_ANIMATION_INSTANCE_ROTATE_CHECK_OR_RETURN(eo_obj);
...
EOLIAN static void
_efl_animation_instance_rotate_efl_animation_instance_progress_set(Eo *eo_obj,
                                                                   Efl_Animation_Instance_Rotate_Data *pd EINA_UNUSED,
                                                                   double progress)
{
   EFL_ANIMATION_INSTANCE_ROTATE_CHECK_OR_RETURN(eo_obj);
...
#define EFL_ANIMATION_INSTANCE_ROTATE_EXTRA_OPS \
   ...
   EFL_OBJECT_OP_FUNC(efl_animation_instance_duration_set, _efl_animation_instance_rotate_efl_animation_instance_duration_set)
