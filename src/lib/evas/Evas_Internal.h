...
EOAPI void efl_animation_instance_interpolator_set(Eo *obj, Efl_Object *interpolator);
EOAPI Efl_Object *efl_animation_instance_interpolator_get(const Eo *obj);
...
/* Efl.Animation.Instance.Translate */
