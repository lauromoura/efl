...
static void
efl_ui_popup_alert_clicked_cb(void *data, const Efl_Event *ev EINA_UNUSED)
{
    Efl_Ui_Popup_Alert_Button type = (int)ev->info;
...
test_efl_ui_popup_alert_text(void *data EINA_UNUSED, Evas_Object *obj EINA_UNUSED, void *event_info EINA_UNUSED)
{
   ...
   efl_gfx_size_hint_max_set(efl_ui_popup, 100, 180);
